    ...
    <Layout>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="card mb-4 sm:mb-6">
          ...
          {/* Advanced Filters */}
          {showFilters && (
            <div className="mt-4 pt-4 border-t border-cream-dark grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-brown mb-2">Type</label>
                <select
                  value={filters.type}
