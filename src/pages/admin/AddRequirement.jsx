...
export default function AdminAddRequirement() {
  const { user } = useAuth()
  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Add Property Requirement</h1>
          <p className="text-gray-600 mt-2">Add a new customer property requirement</p>
        </div>
